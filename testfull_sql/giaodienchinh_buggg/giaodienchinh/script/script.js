                            ...
                            <!-- product-item -->
                                <a href="#" id="0" class="home-product-item">
                                    ...
                                    <div class="home-product-item__price">
                                        <span class="home-product-item__price-old"> ${Math.floor(product.proOldPrice / 1000)}.000đ</span>
                                        <span class="home-product-item__price-current"> ${Math.floor(product.proPrice / 1000)}.000đ </span>
                                    </div>
